...
while game_is_on:
    ...
    if game_ball.distance(r_paddle)<50 and (game_ball.xcor()>330 and game_ball.xcor()<360) or game_ball.distance(l_paddle)<0 and (game_ball.xcor()<-330and game_ball.xcor()>-360):
        game_ball.bounce_x()
